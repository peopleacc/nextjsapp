...
export default function LoginPage() {
 ...
 return (
    ...
    >
        {/* Wave Header */}
        <div className="relative bg-[#2D2E71] h-66 flex flex-col items-center justify-center text-white overflow-hidden">

            {/* Logo */}
            <div className="bg-white p-4 rounded-xl shadow-md z-10 relative">
                <span className="text-[#2D2E71] font-bold text-xl">U</span>
            </div>

            {/* Title */}
            <h1 className="mt-2 text-lg font-semibold tracking-wide z-10 relative">
                ULTIMO
            </h1>
            ...
            >
                <path
                    d="M0,40 C200,120 300,0 500,50 L500,150 L0,150 Z"
