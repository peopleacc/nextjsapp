...
import CardDesign from "@/app/components/comp_design/card_design";
import ModalAddDesign from "@/app/components/comp_design/modal_add";
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden" style={{ height: 'calc(100vh - 14rem)' }}>
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <div>
                    <h2 className="text-xl font-bold text-gray-800">Material List</h2>
                    <p className="text-sm text-gray-600">Manage available materials</p>
                </div>
                <button
