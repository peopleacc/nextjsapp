...
import Modal from "./modal_pen"

export default function Orders_pen({ }) {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            const { data, error } = await supabase
                ...
                .eq("status_pengerjaan", "pending") // filter status
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="text-gray-800 flex">
                            ...
                            <p className="text-xs mt-1"> + {order.users?.no_hp || "Tanpa No HP"} </p>
                        </div>
                    ...
                    <div className="text-right">
                        <button className="bg-green p-4 text- hover:bg-white "
                            onClick={() => setselectorder(order)}   // ✅ fungsi dijalankan hanya saat klik
                        >start</button>
